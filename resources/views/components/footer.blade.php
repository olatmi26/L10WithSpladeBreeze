        ...
        <div class="row text-center">
            <div class="col-md-12">
                <div class="border-top">
                    <p class="py-2 mb-0">Copyright &copy;
                        <script>
                            document.write(new Date().getFullYear());
                        </script> All rights reserved | Amo group of company
                        <i class="icon-heart-o" aria-hidden="true"></i> Developed by <a href="/" target="_blank">Amo
                            group IT Desk</a>
                    </p>
                </div>
            </div>
