<div class="d-flex align-items-stretch flex-shrink-0">
            ...
            <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                        ...
                        <div class="scroll-y mh-200px mh-lg-350px">
                            ...
                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                <div class="symbol symbol-40px me-4">
                                    <img src="{{ asset('application-dashboard/assets/media/avatars/300-6.jpg')}}"
                                        alt="" />
                                </div>
                            ...
                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                <div class="symbol symbol-40px me-4">
                                    <img src="{{asset('application-dashboard/assets/media/avatars/300-9.jpg')}}"
                                        alt="" />
                                </div>
                                <div class="d-flex flex-column justify-content-start fw-semibold">
                            ...
                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                <div class="symbol symbol-40px me-4">
                                    <img src="{{asset('application-dashboard/assets/media/avatars/300-11.jpg')}}"
                                        alt="" />
                                </div>
                                <div class="d-flex flex-column justify-content-start fw-semibold">
                                ...
                                <div class="symbol symbol-40px me-4">
                                    <span class="symbol-label bg-light">
                                        <img class="w-20px h-20px"
                                            src="{{asset('application-dashboard/assets/media/svg/brand-logos/volicity-9.svg')}}"
                                            alt="" />
                                    </span>
                                </div>
                                <div class="d-flex flex-column justify-content-start fw-semibold">
                            ...
                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                <div class="symbol symbol-40px me-4">
                                    <span class="symbol-label bg-light">
                                        <img class="w-20px h-20px"
                                            src="{{asset('application-dashboard/assets/media/svg/brand-logos/tvit.svg')}}"
                                            alt="" />
                                    </span>
                                </div>
                                <div class="d-flex flex-column justify-content-start fw-semibold">
                            ...
                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                <div class="symbol symbol-40px me-4">
                                    <span class="symbol-label bg-light">
                                        <img class="w-20px h-20px"
                                            src="{{asset('application-dashboard/assets/media/svg/misc/infography.svg')}}"
                                            alt="" />
                                    </span>
                                </div>
                                <div class="d-flex flex-column justify-content-start fw-semibold">
                            ...
                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                <div class="symbol symbol-40px me-4">
                                    <span class="symbol-label bg-light">
                                        <img class="w-20px h-20px"
                                            src="{{asset('application-dashboard/assets/media/svg/brand-logos/leaf.svg')}}"
                                            alt="" />
                                    </span>
                                </div>
                                <div class="d-flex flex-column justify-content-start fw-semibold">
                            ...
                            <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                <div class="symbol symbol-40px me-4">
                                    <span class="symbol-label bg-light">
                                        <img class="w-20px h-20px"
                                            src="{{asset('application-dashboard/assets/media/svg/brand-logos/tower.svg')}}"
                                            alt="" />
                                    </span>
                                </div>
                                <div class="d-flex flex-column justify-content-start fw-semibold">
                ...
                <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="../../demo6/dist/pages/search/horizontal.html" class="btn btn-sm fw-bold btn-primary"
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3">
        <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px" id="kt_activities_toggle">
            ...
            <span class="badge badge-light-info fw-bold  rounded px-1 py-1">2</span>
        </div>
    </div>
    <div class="d-flex align-items-center ms-1 ms-lg-3">
        <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
            ...
            <div class="row g-0">
                <!--begin:Item-->
                <div class="col-6">
                    <a href="../../demo6/dist/apps/projects/budget.html"
                ...
                <!--begin:Item-->
                <div class="col-6">
                    <a href="../../demo6/dist/apps/projects/settings.html"
                ...
                <!--begin:Item-->
                <div class="col-6">
                    <a href="../../demo6/dist/apps/projects/list.html"
                ...
                <!--begin:Item-->
                <div class="col-6">
                    <a href="../../demo6/dist/apps/projects/users.html"
    ...
    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
        <div class="cursor-pointer symbol symbol-50px symbol-md-50px  symbol-circle" data-kt-menu-trigger="click"
            data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
            <img src="{{asset('application-dashboard/assets/media/auth/your-picture.png')}}" class="img-thumbnail"
                alt="image" />
            <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">
                <span class="text-start">{{ Auth::user()->fullname ?? 'user name'}}
                    <span class="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">
                        {{Auth::user()->getRoleNames() }}</span>
                </span>
            </span>
        </div>
        ...
        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
            ...
            <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                    {{-- <div class="symbol symbol-50px me-5">
                        <img alt="Logo" src="{{asset('application-dashboard/assets/media/auth/your-picture.png')}}" />
                    </div> --}}
                    <!--begin::Username-->
                    <div class="d-flex flex-column">
                        <div class="fw-bold d-flex align-items-center fs-5">
                            <span class="fw-semibold text-muted me-2">Welcome
                                back</span> {{ Auth::user()->fullname ??
                            'Max
                            smith'}}
                    ...
                    <span class="menu-title position-relative">Language
                        <span
                            ...
                            <img class="w-15px h-15px rounded-1 ms-2"
                                src="{{ asset('application-dashboard/assets/media/flags/united-states.svg')}}"
                                alt="" /></span></span>
                </a>
                <!--begin::Menu sub-->
                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                    ...
                    <div class="menu-item px-3">
                        <a href="../../demo6/dist/account/settings.html" class="menu-link d-flex px-5">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1"
                                    src="{{ asset('application-dashboard/assets/media/flags/spain.svg')}}" alt="" />
                            </span>Spanish</a>
                    </div>
                    <div class="menu-item px-3">
                        <a href="../../demo6/dist/account/settings.html" class="menu-link d-flex px-5">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1"
                                    src="{{ asset('application-dashboard/assets/media/flags/germany.svg')}}" alt="" />
                            </span>German</a>
                    </div>
                    <div class="menu-item px-3">
                        <a href="../../demo6/dist/account/settings.html" class="menu-link d-flex px-5">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1"
                                    src="{{ asset('application-dashboard/assets/media/flags/japan.svg')}}" alt="" />
                            </span>Japanese</a>
                    </div>
                    <div class="menu-item px-3">
                        <a href="../../demo6/dist/account/settings.html" class="menu-link d-flex px-5">
                            <span class="symbol symbol-20px me-4">
                                <img class="rounded-1"
                                    src="{{ asset('application-dashboard/assets/media/flags/france.svg')}}" alt="" />
                            </span>French</a>
                    </div>
                </div>
            </div>
            ...
            <div class="menu-item px-5">
                <a href="../../demo6/dist/authentication/layouts/corporate/sign-in.html" class="menu-link px-5">Sign
                    Out</a>
            </div>
        </div>
